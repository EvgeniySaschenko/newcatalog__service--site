...
import RatingItems from './rating-items-48f849ca.mjs';
import LabelsSections from './labels-sections-871e104a.mjs';
import LinksSources from './links-sources-db528a81.mjs';
import __nuxt_component_0 from './app-preloader-954716fa.mjs';
import __nuxt_component_1 from './app-title-b41355d9.mjs';
...
function ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.rating.linksToSources.length) {
    _push(`<div class="button-sources" data-analyzed-element="rating-button-links-to-sources"><span class="button-sources-text-1">${ssrInterpolate(_ctx.$t("Links to sources"))}</span><span class="button-sources-text-2">${ssrInterpolate(_ctx.$t("Sources"))}</span></div>`);
  } else {
    _push(`<!---->`);
  }
  ...
  if (_ctx.rating.linksToSources.length) {
    ...
    ssrRenderList(_ctx.rating.linksToSources, (item, index2) => {
      _push(`<div class="links-sources__item"><span class="links-sources__number">${ssrInterpolate(`#${index2 + 1}`)}.</span><a class="links-sources__link"${ssrRenderAttr("href", item)} target="_blank" data-analyzed-element="links-to-sources-item">${ssrInterpolate(item)}</a></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
...
//# sourceMappingURL=index-b799f8ba.mjs.map
