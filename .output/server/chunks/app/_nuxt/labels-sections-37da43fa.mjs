...
function ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "labels-sections" }, _attrs))} data-v-6835bfd1><!--[-->`);
...
const LabelsSections = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", ssrRender], ["__scopeId", "data-v-6835bfd1"]]);

export { LabelsSections as default };
//# sourceMappingURL=labels-sections-37da43fa.mjs.map
