...
const LazyAppPreloader = defineAsyncComponent(() => import('./_nuxt/app-preloader-ec8aa324.mjs').then((r) => r.default));
const LazyAppLabelRating = defineAsyncComponent(() => import('./_nuxt/app-label-rating-d234306b.mjs').then((r) => r.default));
const LazyAppTitle = defineAsyncComponent(() => import('./_nuxt/app-title-fad1a54b.mjs').then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d43bb469.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/labels-sections-eedc1865.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/links-sources-386cd2e8.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/rating-items-e1713809.mjs').then((m) => m.default || m)
  },
  {
    name: "ratings-all",
    path: "/ratings-all",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a2f5e7f4.mjs').then((m) => m.default || m)
  },
  {
    name: "section",
    path: "/section",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ac4e20b2.mjs').then((m) => m.default || m)
  }
];
const $router = {
  routes: (routes) => [
    {
      name: "home",
      path: "/",
      component: () => import('./_nuxt/index-a2f5e7f4.mjs')
    },
    {
      name: "ratings-all",
      path: "/:lang",
    ...
    },
    {
      ...
      component: () => import('./_nuxt/index-d43bb469.mjs')
    },
    {
      name: "section",
      path: "/:lang/section/:sectionId",
      component: () => import('./_nuxt/index-ac4e20b2.mjs')
    }
  ]
};
...
function ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$2;
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "app-menu-slider" }, _attrs))} data-v-0f394fb1><!--[-->`);
  ssrRenderList(_ctx.sections, (item, index) => {
    _push(`<li class="app-menu-slider__item" data-v-0f394fb1>`);
    _push(ssrRenderComponent(_component_nuxt_link, {
...
const AppMenuSlider = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", ssrRender$2], ["__scopeId", "data-v-0f394fb1"]]);
...
var GtmElementsEnum = /* @__PURE__ */ ((GtmElementsEnum2) => {
  GtmElementsEnum2[GtmElementsEnum2["header-logo"] = 1] = "header-logo";
  GtmElementsEnum2[GtmElementsEnum2["header-button-menu-main"] = 2] = "header-button-menu-main";
  GtmElementsEnum2[GtmElementsEnum2["header-language-swich-item"] = 3] = "header-language-swich-item";
  GtmElementsEnum2[GtmElementsEnum2["menu-main-button-close"] = 4] = "menu-main-button-close";
  GtmElementsEnum2[GtmElementsEnum2["menu-main-logo"] = 5] = "menu-main-logo";
  GtmElementsEnum2[GtmElementsEnum2["menu-main-item"] = 6] = "menu-main-item";
  GtmElementsEnum2[GtmElementsEnum2["menu-slider-item"] = 7] = "menu-slider-item";
  GtmElementsEnum2[GtmElementsEnum2["rating-button-links-to-sources"] = 8] = "rating-button-links-to-sources";
  GtmElementsEnum2[GtmElementsEnum2["links-to-sources-item"] = 9] = "links-to-sources-item";
  GtmElementsEnum2[GtmElementsEnum2["breadcrumbs-item"] = 10] = "breadcrumbs-item";
  GtmElementsEnum2[GtmElementsEnum2["pagination-item"] = 11] = "pagination-item";
  GtmElementsEnum2[GtmElementsEnum2["ratings-list-title"] = 12] = "ratings-list-title";
  GtmElementsEnum2[GtmElementsEnum2["labels-sections-item"] = 13] = "labels-sections-item";
  GtmElementsEnum2[GtmElementsEnum2["rating-items-item"] = 14] = "rating-items-item";
  GtmElementsEnum2[GtmElementsEnum2["footer-langs-item"] = 15] = "footer-langs-item";
  GtmElementsEnum2[GtmElementsEnum2["page-error-logo"] = 16] = "page-error-logo";
  GtmElementsEnum2[GtmElementsEnum2["page-error-button-home"] = 17] = "page-error-button-home";
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-f593bbd0.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-357cd71e.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
